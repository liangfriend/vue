...
export function staffRegionToBottom(region: MusicScoreRegionEnum, measureHeight: number): number {
    switch (region) {
        case MusicScoreRegionEnum.lower_line_6:
            return -measureHeight * 26 / 16;
        case MusicScoreRegionEnum.lower_space_6:
            return -measureHeight * 24 / 16;
        case MusicScoreRegionEnum.lower_line_5:
            return -measureHeight * 22 / 16;
        case MusicScoreRegionEnum.lower_space_5:
            return -measureHeight * 20 / 16;
        case MusicScoreRegionEnum.lower_line_4:
            return -measureHeight * 18 / 16;
        case MusicScoreRegionEnum.lower_space_4:
            return -measureHeight * 16 / 16;
        case MusicScoreRegionEnum.lower_line_3:
            return -measureHeight * 14 / 16;
        case MusicScoreRegionEnum.lower_space_3:
            return -measureHeight * 12 / 16;
        case MusicScoreRegionEnum.lower_line_2:
            return -measureHeight * 10 / 16;
        case MusicScoreRegionEnum.lower_space_2:
            return -measureHeight * 8 / 16;
        case MusicScoreRegionEnum.lower_line_1:
            return -measureHeight * 6 / 16;
        case MusicScoreRegionEnum.lower_space_1:
            return -measureHeight * 4 / 16;
        case MusicScoreRegionEnum.line_1:
            return -measureHeight * 2 / 16;
        case MusicScoreRegionEnum.space_1:
            return 0;
        case MusicScoreRegionEnum.line_2:
            return measureHeight * 2 / 16;
        case MusicScoreRegionEnum.space_2:
            return measureHeight * 4 / 16;
        case MusicScoreRegionEnum.line_3:
            return measureHeight * 6 / 16;
        case MusicScoreRegionEnum.space_3:
            return measureHeight * 8 / 16;
        case MusicScoreRegionEnum.line_4:
            return measureHeight * 10 / 16;
        case MusicScoreRegionEnum.space_4:
            return measureHeight * 12 / 16;
        case MusicScoreRegionEnum.line_5:
            return measureHeight * 14 / 16;
        case MusicScoreRegionEnum.upper_space_1:
            return measureHeight * 16 / 16;
        case MusicScoreRegionEnum.upper_line_1:
            return measureHeight * 18 / 16;
        case MusicScoreRegionEnum.upper_space_2:
            return measureHeight * 20 / 16;
        case MusicScoreRegionEnum.upper_line_2:
            return measureHeight * 22 / 16;
        case MusicScoreRegionEnum.upper_space_3:
            return measureHeight * 24 / 16;
        case MusicScoreRegionEnum.upper_line_3:
            return measureHeight * 26 / 16;
        case MusicScoreRegionEnum.upper_space_4:
            return measureHeight * 28 / 16;
        case MusicScoreRegionEnum.upper_line_4:
            return measureHeight * 30 / 16;
        case MusicScoreRegionEnum.upper_space_5:
            return measureHeight * 32 / 16;
        case MusicScoreRegionEnum.upper_line_5:
            return measureHeight * 34 / 16;
        case MusicScoreRegionEnum.upper_space_6:
            return measureHeight * 36 / 16;
        case MusicScoreRegionEnum.upper_line_6:
            return measureHeight * 38 / 16;
        case MusicScoreRegionEnum.upper_space_7:
            return measureHeight * 40 / 16;
        case MusicScoreRegionEnum.upper_line_7:
            return measureHeight * 42 / 16;
        case MusicScoreRegionEnum.upper_space_8:
            return measureHeight * 44 / 16;
        case MusicScoreRegionEnum.upper_line_8:
